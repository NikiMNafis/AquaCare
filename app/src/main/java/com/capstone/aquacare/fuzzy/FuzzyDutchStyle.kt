...
data class ReturnCheckParameter(val temperature: String, val ph: String, val ammonia: String, val kh: String, val gh: String)
...
class FuzzyDutchStyle {
    ...
    fun checkParameter(suhu: Double, ph: Double, ammonia: Double, kh: Double, gh: Double): ReturnCheckParameter {
        ...
        return ReturnCheckParameter(_temperature, _ph, _ammonia, _kh, _gh)
    }
